...
class SPUArgs
{
 public:
  ...
  unsigned int rain_array_length;//4
  addr64_t exp_1_ea;//8
  addr64_t exp_2_ea;//8
  unsigned int exp_array_length;//4
  
  //Used only by SPU2. One class for ease
...
const unsigned int EXPLOSION = 4;
const unsigned int RAIN = 5;
